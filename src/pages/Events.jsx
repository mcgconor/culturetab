    ...
    <div className="animate-fade-in relative">
      ...
      <div className="px-4">
        {loading ? (
            ...
            <div className="text-center py-20 text-gray-400">No events found matching your filters.</div>
        ) : (
            <div className="space-y-4">
                {filteredEvents.map(item => (
                    <UniversalCard key={item.id} item={item} type="public" onAction={handleLogThis} />
                ))}
            </div>
        )}
      </div>
